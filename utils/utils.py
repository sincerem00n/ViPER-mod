...
def get_safe_zone_frontier(safe_info, map_info):
    ...
    safe_zone = np.pad(safe_zone, ((1, 1), (1, 1)), 'constant', constant_values=0)
    ...
    obstacle = np.pad(obstacle, ((1, 1), (1, 1)), 'constant', constant_values=1)  # add obstacle around extended map
